 ...
 */
#define ESP_PANEL_BOARD_NAME                "Makerfabs:MaTouch 7_V1.1"
 ...
 */
#define ESP_PANEL_BOARD_LCD_CONTROLLER      ST7262//ILI9341
 ...
 */
#define ESP_PANEL_BOARD_LCD_RST_IO              (38)    // Reset pin, -1 if not used
 ...
 * - `XPT2046`
 */
#define ESP_PANEL_BOARD_TOUCH_CONTROLLER        GT911//TT21100
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (10)    // Output GPIO pin number
 ...
 * - `TCA95XX_16BIT`
 */
#define ESP_PANEL_BOARD_EXPANDER_CHIP           CH422G//TCA95XX_8BIT
